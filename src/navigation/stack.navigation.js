    ...
    return (
        <NavigationContainer>
            <Stack.Navigator initialRouteName="SawariHome" screenOptions={{
                ...
                <Stack.Screen name={Constants.NavigationItems.RegisterScreen}  component={Screens.RegisterScreen} options={{ title: "Sawari Login" }} />
                ...
                <Stack.Screen name={Constants.NavigationItems.ProfileScreen}  component={Screens.ProfileScreen} options={{ title: "Profile" }} />
